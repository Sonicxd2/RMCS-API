...
public interface CommandsAPI {
     ...
     * @param usagePredicte предикат использования: консоль никогда не может использовать команды, зарегистрированные
     ...
     */
    void register(String name, String usage, PlayerPredicate usagePredicte, CommandInterface command, String... aliases);
